Here’s the **updated list of API endpoints**, considering the **buyer-seller model** where **sellers (shops/restaurants) manage their own menus** and **buyers (persons) place orders**.
